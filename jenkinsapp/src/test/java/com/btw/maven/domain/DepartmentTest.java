...
import static com.btw.maven.domain.DepartmentTestSamples.*;
import static com.btw.maven.domain.EmployeeTestSamples.*;
import static com.btw.maven.domain.JobHistoryTestSamples.*;
import static com.btw.maven.domain.LocationTestSamples.*;
