...
describe('Employee Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Employee query and add missing value', () => {
      ...
      const manager: IEmployee = { id: 28099 };
      employee.manager = manager;

      const employeeCollection: IEmployee[] = [{ id: 28332 }];
    ...
    it('Should call Department query and add missing value', () => {
      const employee: IEmployee = { id: 456 };
      const department: IDepartment = { id: 7258 };
      employee.department = department;

      const departmentCollection: IDepartment[] = [{ id: 25359 }];
    ...
    it('Should update editForm', () => {
      const employee: IEmployee = { id: 456 };
      const manager: IEmployee = { id: 297 };
      employee.manager = manager;
      const department: IDepartment = { id: 18433 };
      employee.department = department;
