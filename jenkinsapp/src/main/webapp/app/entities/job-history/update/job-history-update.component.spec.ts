...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 4733 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 23551 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 32436 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 2483 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 15321 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 31444 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 3770 };
      jobHistory.job = job;
      const department: IDepartment = { id: 11115 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 2145 };
      jobHistory.employee = employee;
