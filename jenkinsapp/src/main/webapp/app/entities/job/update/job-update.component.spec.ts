...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 1763 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 7626 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 18944 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 4846 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 32227 };
      job.tasks = [task];
      const employee: IEmployee = { id: 30868 };
      job.employee = employee;
